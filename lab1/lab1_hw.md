...
R is scripting language and that is an open source, while RStudio is the GUI and which is used to interact with R for us to use. GuI stands for graphical user interface.
GitHub is useful because we can share our code through our community and world to learn more about code.

...
R is scripting language and that is an open source, while RStudio is the GUI and which is used to interact with R for us to use. GuI is stand for graphical user interface.
